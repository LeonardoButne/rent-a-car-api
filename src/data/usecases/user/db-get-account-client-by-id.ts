...
import { GetAccountClientByIdRepository } from "../../repositories/user/get-account-client-by-id-repository"

export class DbGetAccountClientById implements GetAccountClient {
    constructor(
        private readonly getAccountClientByIdRepository: GetAccountClientByIdRepository,
    ) {}
